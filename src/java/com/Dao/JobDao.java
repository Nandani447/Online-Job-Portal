...
public class JobDao {
    ...
    public boolean AddJob(Jobs j) {
        ...
        try {
            ...
            String s = "insert into jobs(title, description, category, status, location) values(?,?,?,?,?)";
    ...
    public boolean updateJob(Jobs j) {
        ...
        try {
            ...
            String s = "update jobs set title=?, description=?, category=?, status=?, location=? where id=?";
